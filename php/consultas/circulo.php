        ...
        <table class="table table-hover">
            ...
            ?>
                <tr><td><?php echo $linha['idcirculo'];?></td>
                    ...
                    <td><a onclick="return confirm('Deseja mesmo excluir?')" href="../control/acao.php?idcirculo=<?php echo $linha['idcirculo'];?>&table=circulo&action=excluir"><img src="../../img/delete.svg" style="width: 1.8vw;"></a></td>
