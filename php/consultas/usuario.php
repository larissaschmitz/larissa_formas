        ...
        <table class="table table-hover">
                ...
                <form method="post">
                    <div class="form-group col-lg-3">
                        ...
                        <input type="radio" name="buscar" value="2" class="form-check-input" <?php if ($buscar == "2") echo "checked" ?>> Nome<br>
                        <input type="radio" name="buscar" value="3" class="form-check-input" <?php if ($buscar == "3") echo "checked" ?>> Usuário<br>
                    </div>
                    <br><br>
                </form>
            ...
            ?>
                <tr><td><?php echo $linha['idusuario'];?></td>
                    ...
                    <td><a href='../cadastros/cadUsuario.php?idusuario=<?php echo $linha['idusuario'];?>&action=editar'><img src="../../img/edit.svg" style="width: 1.8vw;"></a></td>
                    <td><a onclick="return confirm('Deseja mesmo excluir?')" href=  "../control/acao.php?idusuario=<?php echo $linha['idusuario'];?>&table=usuario&action=excluir"><img src="../../img/delete.svg" style="width: 1.8vw;"></a></td>
                </tr>
            <?php 
                } 
            ?> 
