...
<body>
    ...
    <div class="container-fluid">
        <form method="post" action="acao.php">
            Lado 1: <input name="base" id="base" type="number" required="true" placeholder="Digite o lado" value="<?php if ($action == "editar"){echo $dados['base'];}?>"><br>         
            Lado 2: <input name="lado1" id="lado1" type="number" required="true" placeholder="Digite o lado" value="<?php if ($action == "editar"){echo $dados['lado1'];}?>"><br>         
            Lado 3: <input name="lado2" id="lado2" type="number" required="true" placeholder="Digite o lado" value="<?php if ($action == "editar"){echo $dados['lado2'];}?>"><br>         
            <br>
