...
<body>
    ...
    <div class="container-fluid">
        <form method="post" action="acao.php">
            Raio: <input name="raio" id="raio" type="number" required="true" placeholder="Digite o raio" value="<?php if ($action == "editar"){echo $dados['raio'];}?>"><br>         
            <br>
            ...
            <input type="hidden" name="idcirculo" id="" value="<?php if($action == "editar"){echo $dados['idcirculo'];}?>">
